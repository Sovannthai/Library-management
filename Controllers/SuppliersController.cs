...
namespace Library.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,CompanyName,Phone,Email,Address")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,CompanyName,Phone,Email,Address")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
